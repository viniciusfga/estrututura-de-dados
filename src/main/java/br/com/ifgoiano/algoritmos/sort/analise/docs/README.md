...
📦 sort-analise/
└── src/
    └── br/com/ifgoiano/algoritmos/sort/analise/
         ├── docs/
         │    ├── README.md     
...
```bash
javac -d out src/br/com/ifgoiano/algoritmos/sort/analise/*.java
cd out
```

**2. Teste rápido — verificação de correção (execução única por tamanho)**
```bash
java br.com.ifgoiano.algoritmos.sort.analise.TesteOrdena --rapido
```

**3. Testes completos — 100 execuções por dataset/algoritmo**
```bash
java br.com.ifgoiano.algoritmos.sort.analise.TesteOrdena
```
